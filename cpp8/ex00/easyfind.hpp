...
Si aucune occurrence n’a été trouvée, vous pouvez soit jeter une exception, soit retourner une valeur d’erreur de votre choix. Si vous avez besoin d’inspiration, jetez un oeil
